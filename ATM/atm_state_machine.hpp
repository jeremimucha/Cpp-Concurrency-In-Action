#ifndef guard_ATM_STATE_MACHINE_HPP_
#define guard_ATM_STATE_MACHINE_HPP_

#include <string>
#include "atm_states.hpp"
#include "MessagePassingFramework/receiver.hpp"
#include "MessagePassingFramework/sender.hpp"
...
class atm
{
    ...
    void(atm::*state)();    // member function pointer to atm state
    std::string account;
...
#endif /* guard_ATM_STATE_MACHINE_HPP_ */
